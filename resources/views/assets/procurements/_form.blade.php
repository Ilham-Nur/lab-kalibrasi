    ...
    <div class="modal-body">
      <div class="form-grid">
        ...
        <div class="form-group">
          ...
          <select class="form-select" name="asset_supplier_id" required>
            <option value="">Pilih supplier</option>
            @foreach($suppliers as $supplier)
              <option value="{{ $supplier->id }}" @selected(old('asset_supplier_id', $procurement->asset_supplier_id) == $supplier->id)>{{ $supplier->name }}</option>
            @endforeach
          </select>
        </div>
        <div class="form-group">
          <label class="form-label">Tambah Supplier Baru</label>
          <a class="btn btn-outline btn-sm" href="{{ route('suppliers.create') }}"><i class="bi bi-plus-lg"></i> Supplier / Vendor</a>
        </div>
